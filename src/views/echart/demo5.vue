<template>
  <div>
    <div class="qie" @click="next">
      <img src="../../assets/img/qhbutton.png" alt="" />
    </div>
    <div class="qie1" @click="sx">
      <img
        v-show="ssImg1"
        class="img1"
        src="../../assets/img/ssbutton.png"
        alt=""
      /><img
        v-show="ssImg2"
        class="img2"
        src="../../assets/img/ztbutton.png"
        alt=""
      />
    </div>
    <el-carousel
...
.bg {
  ...
  .echartBox {
    width: 100%;
    height: 100%;
    background-image: url("../../assets/img/demo5bg2.jpg");
